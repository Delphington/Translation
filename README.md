...
Транслятор для языка арифметических выражений из лаб 1-4. Написан на питоне.
...
## Грамматика (из задания 2, без левой рекурсии)
...
Везде пишет строку и позицию.

## Тесты

В папке tests примеры выражений.
